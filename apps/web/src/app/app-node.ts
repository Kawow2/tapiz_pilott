...
import { SHAPE_CONFIG } from './modules/board/components/shape';
...
import { ARROW_NODE_CONFIG } from './modules/board/components/arrows/arrow-node';
...
registerNode('shape', SHAPE_CONFIG);
